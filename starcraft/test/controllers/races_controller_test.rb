...
class RacesControllerTest < ActionController::TestCase
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post :create, race: { description: @race.description, homeworld: @race.homeworld, name: @race.name }
    end
  ...
  test "should update race" do
    patch :update, id: @race, race: { description: @race.description, homeworld: @race.homeworld, name: @race.name }
    assert_redirected_to race_path(assigns(:race))
  end
